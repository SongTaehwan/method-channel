...
class MessageApi {
  ...
  Future<List<MyMessage?>> getMessages(String fromEmail) async {
    const String __pigeon_channelName = 'dev.flutter.pigeon.batterylevel.MessageApi.getMessages';
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[fromEmail]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<MyMessage?>();
    }
  }
}
